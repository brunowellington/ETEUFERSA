...
const emptyLagoasBaseStringData: LagoasBaseStringData = {
  ...
  quantidadeLagoas: "2",
  proporcao: "2.5",
  proporcaoAnaerobia: "1.5",
  k: "0.35", // valor para so facultativa
  //k: "0.27", // valor para as duas lagoas
  dqo: "500",
  aplicacaoSuper: "220",
  eficienciaAnaerobia: "60",
  concentracaoSSefluente: "80",
  concentracaoSSDBO5: "0.35",
  hAnaerobia: "4.5",
  hFacultativa: "1.8",
  coliformesFecais: "10000000",
  ovosHelmintos: "200",
